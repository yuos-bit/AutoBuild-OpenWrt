...
git clone -b master https://github.com/yuos-bit/luci-theme-edge package/luci-theme-edge
git clone -b master https://github.com/yuos-bit/luci-theme-netgear package/luci-theme-netgear
# 更改默认wifi
